...
def load_model(path, custom_objects={}, verbose=0):
    ...
    custom_objects.update({"Model": Model})  # Add Model to custom objects
...
def reconstruct(Iorig, I, Y, out_size, threshold=0.9):
    ...
    if len(final_labels):
        ...
        for i, label in enumerate(final_labels):
            ...
            Ilp = cv2.warpPerspective(Iorig, H, out_size, borderValue=0.0)
